...
#filepath and name
training_file = "/Users/clarissaseebohm/Desktop/ME EN 5510/Project/cs-ap/data/training_data/training_data.csv"
...
plt.title("Radius vs Max Stress (Sample Size - 10)")
plt.xlabel("Radius")
plt.ylabel("Max Stress")
